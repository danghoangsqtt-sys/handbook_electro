...
export default function IntroStats() {
    ...
    return (
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl sm:rounded-3xl p-4 sm:p-8 text-white relative overflow-hidden shadow-xl border border-slate-700/50">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-center">
                <div className="lg:col-span-8">
                    ...
                    <h2 className="text-2xl sm:text-4xl font-extrabold sm:mt-3 tracking-tight text-white drop-shadow-sm">Từ Điển Bách Khoa Công Nghệ Số</h2>
                    <p className="hidden sm:block text-slate-300 mt-2 text-sm sm:text-base leading-relaxed">
                        Hơn <span className="text-cyan-400 font-bold">3000 thuật ngữ cốt lõi và thực tiễn</span> được giải nghĩa chi tiết kèm mô phỏng tương tác. Phân loại theo 7 chủ điểm: Cơ điện tử, Tự động hóa, Khoa học máy tính, Vi xử lý, Điện tử số, Vô tuyến & Viễn thông, và Module/Linh kiện nhúng.
                    </p>
                </div>
                
                <div className="lg:col-span-4 bg-white/5 border border-white/10 rounded-2xl p-4 backdrop-blur-sm">
                    <h3 className="text-xs font-bold uppercase tracking-wider text-slate-300 mb-3"><i className="fa-solid fa-chart-pie mr-1 text-cyan-400"></i> Tiến trình học tập</h3>
                    <div className="flex flex-col gap-2.5">
                        <div>
                            ...
                            <div className="w-full bg-slate-800 h-1.5 rounded-full overflow-hidden">
                                <div className="bg-cyan-500 h-full transition-all duration-300" style={{ width: `${progressPercent}%` }}></div>
                            </div>
                        </div>
                        <div>
                            <div className="flex justify-between text-xs mb-1">
