    ...
    return (
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center py-8 px-4">
            ...
            <button 
                ...
                className="mt-8 px-6 py-2.5 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800/50 rounded-xl font-bold transition-colors flex items-center gap-2"
            >
